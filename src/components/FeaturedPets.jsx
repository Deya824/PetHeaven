    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">Discover these woanderful companions who are patiently waiting for a loving family. Your new best friend might be right here!</p>
        </div>
